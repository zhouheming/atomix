...
public class GroupMembershipEvent extends AbstractEvent<GroupMembershipEvent.Type, Member> {
   ...
   */
  public GroupMembershipEvent(Type type, Member instance) {
    super(type, instance);
  }
   ...
   */
  public GroupMembershipEvent(Type type, Member instance, long time) {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof GroupMembershipEvent) {
      final GroupMembershipEvent other = (GroupMembershipEvent) obj;
